...
func (api *UsersApi) DeleteUserBucketKeyById(userExtId *string, extId *string, args ...map[string]interface{}) (*import1.DeleteUserKeyApiResponse, error) {
	...
	uri := "/api/iam/v4.0.b1/authn/users/{userExtId}/buckets-access-keys/{extId}"
...
// Delete a User.
func (api *UsersApi) DeleteUserById(extId *string, args ...map[string]interface{}) (*import1.DeleteUserApiResponse, error) {
	argMap := make(map[string]interface{})
	if len(args) > 0 {
		argMap = args[0]
	}
	...
	unmarshalledResp := new(import1.DeleteUserApiResponse)
	json.Unmarshal(responseBody.([]byte), &unmarshalledResp)
	return unmarshalledResp, err
}
