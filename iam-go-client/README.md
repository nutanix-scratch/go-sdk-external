...
```shell
$ go get github.com/nutanix-scratch/go-sdk-external/iam-go-client/v4/...
```

##### Install a specific version

```shell
$ go get github.com/nutanix-scratch/go-sdk-external/iam-go-client/v4/...@v4.0.1-beta.1
```
...
require (
	github.com/nutanix-scratch/go-sdk-external/iam-go-client/v4 latest
)
```
...
require (
	github.com/nutanix-scratch/go-sdk-external/iam-go-client/v4 v4.0.1-beta.1
)
```
...
import (
	"github.com/nutanix-scratch/go-sdk-external/iam-go-client/v4/client"
	"github.com/nutanix-scratch/go-sdk-external/iam-go-client/v4/api"
)
...
extId := "3bc0eF85-c8Ae-DcBE-8Fdf-AfebAeccdDcc"
...
response, err := CertificateAuthenticationProvidersApiInstance.UpdateCertAuthProviderById(&certAuthProvider&extId, , args)
if err != nil {
....
}
```
...
// 
response, err := CertificateAuthenticationProvidersApiInstance.ListCertAuthProviders(&filter_, &orderby_, &select_)
if err != nil {
    ....
}
