# Go Client For Nutanix Licensing Versioned APIs

The Go client for Nutanix Licensing Versioned APIs is designed for Go client application developers offering them simple and flexible access to APIs that licensing desc placeholder.
...
```shell
$ go get github.com/nutanix-scratch/go-sdk-external/licensing-go-client/v4/...
```

##### Install a specific version

```shell
$ go get github.com/nutanix-scratch/go-sdk-external/licensing-go-client/v4/...@v4.0.1-beta.1
```
...
require (
	github.com/nutanix-scratch/go-sdk-external/licensing-go-client/v4 latest
)
```
...
require (
	github.com/nutanix-scratch/go-sdk-external/licensing-go-client/v4 v4.0.1-beta.1
)
```


## Configuration
The Go client for Nutanix Licensing Versioned APIs can be configured with the following parameters
...
```go
import (
	"github.com/nutanix-scratch/go-sdk-external/licensing-go-client/v4/client"
)
var (
...
import (
	"github.com/nutanix-scratch/go-sdk-external/licensing-go-client/v4/client"
	"github.com/nutanix-scratch/go-sdk-external/licensing-go-client/v4/api"
)
...
// Initialize the API
LicensesApiInstance = api.NewLicensesApi(ApiClientInstance)
page_ := 0
limit_ := 50
...
// 
response, err := LicensesApiInstance.ListFeatures(&page_, &limit_, &filter_, &orderby_, &select_)
if err != nil {
    ....
}
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=licensing&version=v4.0.a1&language=go). This documentation is auto-generated, and the location may change.
