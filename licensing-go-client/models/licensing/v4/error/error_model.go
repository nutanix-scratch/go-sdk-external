/*
 * Generated file models/licensing/v4/error/error_model.go.
 *
...
func NewAppMessage() *AppMessage {
	...
	*p.ObjectType_ = "licensing.v4.error.AppMessage"
...
func NewErrorResponse() *ErrorResponse {
	p := new(ErrorResponse)
	p.ObjectType_ = new(string)
	*p.ObjectType_ = "licensing.v4.error.ErrorResponse"
	p.Reserved_ = map[string]interface{}{"$fv": "v4.r0.a1"}
	p.UnknownFields_ = map[string]interface{}{}
...
func NewSchemaValidationError() *SchemaValidationError {
	...
	p.ObjectType_ = new(string)
	*p.ObjectType_ = "licensing.v4.error.SchemaValidationError"
	p.Reserved_ = map[string]interface{}{"$fv": "v4.r0.a1"}
	p.UnknownFields_ = map[string]interface{}{}
...
func NewSchemaValidationErrorMessage() *SchemaValidationErrorMessage {
	...
	p.ObjectType_ = new(string)
	*p.ObjectType_ = "licensing.v4.error.SchemaValidationErrorMessage"
	p.Reserved_ = map[string]interface{}{"$fv": "v4.r0.a1"}
	p.UnknownFields_ = map[string]interface{}{}
...
func (p *OneOfErrorResponseError) UnmarshalJSON(b []byte) error {
	...
	if err := json.Unmarshal(b, vOneOfType201); err == nil {
		...
		if len(*vOneOfType201) == 0 || "licensing.v4.error.AppMessage" == *((*vOneOfType201)[0].ObjectType_) {
	...
	if err := json.Unmarshal(b, vOneOfType202); err == nil {
		if "licensing.v4.error.SchemaValidationError" == *vOneOfType202.ObjectType_ {
			if nil == p.oneOfType202 {
				p.oneOfType202 = new(SchemaValidationError)
			}
