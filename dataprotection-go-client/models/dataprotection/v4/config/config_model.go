...
import (
	...
	"errors"
	"fmt"
	import5 "github.com/nutanix-scratch/go-sdk-external/dataprotection-go-client/v4/models/common/v1/config"
	import2 "github.com/nutanix-scratch/go-sdk-external/dataprotection-go-client/v4/models/common/v1/response"
	import4 "github.com/nutanix-scratch/go-sdk-external/dataprotection-go-client/v4/models/dataprotection/v4/common"
	import1 "github.com/nutanix-scratch/go-sdk-external/dataprotection-go-client/v4/models/dataprotection/v4/error"
	import3 "github.com/nutanix-scratch/go-sdk-external/dataprotection-go-client/v4/models/prism/v4/config"
	"time"
)
...
type RecoveryPoint struct {
	...
	*/
	VendorSpecificProperties []import4.VendorSpecificProperty `json:"vendorSpecificProperties,omitempty"`
	/*
