...
func (api *RecoveryPointsApi) CreateRecoveryPoint(body *import1.RecoveryPoint, args ...map[string]interface{}) (*import1.CreateRecoveryPointApiResponse, error) {
	...
	uri := "/api/dataprotection/v4.0.b1/config/recovery-points"
...
func (api *RecoveryPointsApi) DeleteRecoveryPointById(extId *string, args ...map[string]interface{}) (*import1.DeleteRecoveryPointApiResponse, error) {
	...
	uri := "/api/dataprotection/v4.0.b1/config/recovery-points/{extId}"
...
func (api *RecoveryPointsApi) ListRecoveryPoints(page_ *int, limit_ *int, filter_ *string, orderby_ *string, select_ *string, args ...map[string]interface{}) (*import1.ListRecoveryPointsApiResponse, error) {
	argMap := make(map[string]interface{})
	if len(args) > 0 {
		argMap = args[0]
	}
...
func (api *RecoveryPointsApi) ReplicateRecoveryPoint(extId *string, body *import1.RecoveryPointReplicationSpec, args ...map[string]interface{}) (*import1.RecoveryPointReplicateApiResponse, error) {
	...
	uri := "/api/dataprotection/v4.0.b1/config/recovery-points/{extId}/$actions/replicate"
...
func (api *RecoveryPointsApi) RestoreRecoveryPoint(extId *string, body *import1.RecoveryPointRestorationSpec, args ...map[string]interface{}) (*import1.RecoveryPointRestoreApiResponse, error) {
	...
	uri := "/api/dataprotection/v4.0.b1/config/recovery-points/{extId}/$actions/restore"
...
func (api *RecoveryPointsApi) SetRecoveryPointExpirationTime(extId *string, body *import1.ExpirationTimeSpec, args ...map[string]interface{}) (*import1.UpdateRecoveryPointExpirationTimeApiResponse, error) {
	...
	uri := "/api/dataprotection/v4.0.b1/config/recovery-points/{extId}/$actions/set-expiration-time"
...
// Returns metadata with the changed region details between any two disk recovery points of a file. This API can be used for both incremental and differential backups and a full backup, as it indicates the regions that are zeroes, thereby helping avoid copy of zero regions.
func (api *RecoveryPointsApi) VmRecoveryPointComputeChangedRegions(recoveryPointExtId *string, vmRecoveryPointExtId *string, extId *string, body *import1.VmRecoveryPointComputeChangedRegionsRequest, args ...map[string]interface{}) (*import1.ComputeChangedRegionsResponseModel, error) {
	argMap := make(map[string]interface{})
	if len(args) > 0 {
		argMap = args[0]
	}

	uri := "/api/dataprotection/v4.0.b1/config/recovery-points/{recoveryPointExtId}/vm-recovery-points/{vmRecoveryPointExtId}/disk-recovery-points/{extId}/$actions/compute-changed-regions"
	...
	unmarshalledResp := new(import1.ComputeChangedRegionsResponseModel)
	json.Unmarshal(responseBody.([]byte), &unmarshalledResp)
	return unmarshalledResp, err
}

// Returns metadata with the changed region details between any two disk recovery points of a file. This API can be used for both incremental and differential backups and a full backup, as it indicates the regions that are zeroes, thereby helping avoid copy of zero regions.
func (api *RecoveryPointsApi) VolumeGroupRecoveryPointComputeChangedRegions(recoveryPointExtId *string, volumeGroupRecoveryPointExtId *string, extId *string, body *import1.VolumeGroupRecoveryPointComputeChangedRegionsRequest, args ...map[string]interface{}) (*import1.ComputeChangedRegionsResponseModel, error) {
	argMap := make(map[string]interface{})
	if len(args) > 0 {
		argMap = args[0]
	}

	uri := "/api/dataprotection/v4.0.b1/config/recovery-points/{recoveryPointExtId}/volume-group-recovery-points/{volumeGroupRecoveryPointExtId}/disk-recovery-points/{extId}/$actions/compute-changed-regions"
