# Go Client For Nutanix Dataprotection Versioned APIs
...
```shell
$ go get github.com/nutanix-scratch/go-sdk-external/dataprotection-go-client/v4/...
```

##### Install a specific version

```shell
$ go get github.com/nutanix-scratch/go-sdk-external/dataprotection-go-client/v4/...@v4.0.1-beta.1
```
...
require (
	github.com/nutanix-scratch/go-sdk-external/dataprotection-go-client/v4 latest
)
```
...
require (
	github.com/nutanix-scratch/go-sdk-external/dataprotection-go-client/v4 v4.0.1-beta.1
)
```
...
import (
	"github.com/nutanix-scratch/go-sdk-external/dataprotection-go-client/v4/client"
	"github.com/nutanix-scratch/go-sdk-external/dataprotection-go-client/v4/api"
)
...
extId := "CEa4ad64-FBcD-4c8D-d42B-de2Ca506e7aA"
...
// 
response, err := ConsistencyGroupsApiInstance.ListConsistencyGroups(&page_, &limit_, &filter_, &orderby_, &select_)
if err != nil {
    ....
}
