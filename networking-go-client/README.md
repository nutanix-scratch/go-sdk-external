# Go Client For Nutanix Networking Versioned APIs

The Go client for Nutanix Networking Versioned APIs is designed for Go client application developers offering them simple and flexible access to APIs that manage networking configuration on Nutanix clusters, including AHV and advanced networking.
...
```shell
$ go get github.com/nutanix-scratch/go-sdk-external/networking-go-client/v4/...
```

##### Install a specific version

```shell
$ go get github.com/nutanix-scratch/go-sdk-external/networking-go-client/v4/...@v4.0.1-beta.1
```
...
require (
	github.com/nutanix-scratch/go-sdk-external/networking-go-client/v4 latest
)
```
...
require (
	github.com/nutanix-scratch/go-sdk-external/networking-go-client/v4 v4.0.1-beta.1
)
```


## Configuration
The Go client for Nutanix Networking Versioned APIs can be configured with the following parameters
...
import (
	"github.com/nutanix-scratch/go-sdk-external/networking-go-client/v4/client"
	"github.com/nutanix-scratch/go-sdk-external/networking-go-client/v4/api"
)
...
// Initialize the API
BgpSessionsApiInstance = api.NewBgpSessionsApi(ApiClientInstance)
page_ := 0
limit_ := 50
...
// 
response, err := BgpSessionsApiInstance.ListBgpSessions(&page_, &limit_, &filter_, &orderby_, &expand_)
if err != nil {
    ....
}
