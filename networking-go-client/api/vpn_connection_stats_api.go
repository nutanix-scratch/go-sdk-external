...
import (
	...
	import2 "github.com/nutanix-scratch/go-sdk-external/networking-go-client/v4/models/common/v1/stats"
	import3 "github.com/nutanix-scratch/go-sdk-external/networking-go-client/v4/models/networking/v4/stats"
	"net/http"
	"net/url"
	"strings"
)
...
func (api *VpnConnectionStatsApi) GetVpnConnectionStats(extId *string, startTime_ *string, endTime_ *string, samplingInterval_ *int, statType_ *import2.DownSamplingOperator, page_ *int, limit_ *int, select_ *string, args ...map[string]interface{}) (*import3.GetVpnConnectionStatsApiResponse, error) {
	...
	unmarshalledResp := new(import3.GetVpnConnectionStatsApiResponse)
