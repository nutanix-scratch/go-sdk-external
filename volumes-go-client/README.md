# Go Client For Nutanix Volumes Versioned APIs

The Go client for Nutanix Volumes Versioned APIs is designed for Go client application developers offering them simple and flexible access to APIs that configure volumes.
...
```shell
$ go get github.com/nutanix-scratch/go-sdk-external/volumes-go-client/v4/...
```

##### Install a specific version

```shell
$ go get github.com/nutanix-scratch/go-sdk-external/volumes-go-client/v4/...@v4.0.1-beta.1
```
...
require (
	github.com/nutanix-scratch/go-sdk-external/volumes-go-client/v4 latest
)
```
...
require (
	github.com/nutanix-scratch/go-sdk-external/volumes-go-client/v4 v4.0.1-beta.1
)
```


## Configuration
The Go client for Nutanix Volumes Versioned APIs can be configured with the following parameters
...
```go
import (
	"github.com/nutanix-scratch/go-sdk-external/volumes-go-client/v4/client"
)
var (
...
import (
	"github.com/nutanix-scratch/go-sdk-external/volumes-go-client/v4/client"
	"github.com/nutanix-scratch/go-sdk-external/volumes-go-client/v4/api"
)

var (
	ApiClientInstance *client.ApiClient
	IscsiClientsApiInstance *api.IscsiClientsApi
)
...
extId := "9eBcFaEF-aFBb-dDAd-a8E9-AA9fB0cda9fB"
...
// 
response, err := IscsiClientsApiInstance.ListIscsiClients(&page_, &limit_, &filter_, &orderby_, &expand_, &select_)
if err != nil {
    ....
}
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=volumes&version=v4.0.b1&language=go). This documentation is auto-generated, and the location may change.
