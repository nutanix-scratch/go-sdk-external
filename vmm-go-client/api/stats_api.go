...
import (
	...
	import1 "github.com/nutanix-scratch/go-sdk-external/vmm-go-client/v4/models/common/v1/stats"
	import6 "github.com/nutanix-scratch/go-sdk-external/vmm-go-client/v4/models/vmm/v4/ahv/stats"
	"net/http"
	"net/url"
	"strings"
)
...
func (api *StatsApi) GetVmDiskStats(vmExtId *string, extId *string, startTime_ *string, endTime_ *string, samplingInterval_ *int, statType_ *import1.DownSamplingOperator, select_ *string, args ...map[string]interface{}) (*import6.GetVmDiskStatsResponse, error) {
	argMap := make(map[string]interface{})
	if len(args) > 0 {
		argMap = args[0]
	}

	uri := "/api/vmm/v4.0.b1/ahv/stats/vms/{vmExtId}/disks/{extId}"
	...
	unmarshalledResp := new(import6.GetVmDiskStatsResponse)
...
func (api *StatsApi) GetVmStats(extId *string, startTime_ *string, endTime_ *string, samplingInterval_ *int, statType_ *import1.DownSamplingOperator, select_ *string, args ...map[string]interface{}) (*import6.GetVmStatsResponse, error) {
	argMap := make(map[string]interface{})
	if len(args) > 0 {
		argMap = args[0]
	}

	uri := "/api/vmm/v4.0.b1/ahv/stats/vms/{extId}"
	...
	unmarshalledResp := new(import6.GetVmStatsResponse)
	json.Unmarshal(responseBody.([]byte), &unmarshalledResp)
	return unmarshalledResp, err
}
...
func (api *StatsApi) ListVmStats(startTime_ *string, endTime_ *string, samplingInterval_ *int, statType_ *import1.DownSamplingOperator, page_ *int, limit_ *int, filter_ *string, orderby_ *string, select_ *string, args ...map[string]interface{}) (*import6.ListVmStatsResponse, error) {
	argMap := make(map[string]interface{})
	if len(args) > 0 {
		argMap = args[0]
	}

	uri := "/api/vmm/v4.0.b1/ahv/stats/vms"
	...
	unmarshalledResp := new(import6.ListVmStatsResponse)
	json.Unmarshal(responseBody.([]byte), &unmarshalledResp)
	return unmarshalledResp, err
}
