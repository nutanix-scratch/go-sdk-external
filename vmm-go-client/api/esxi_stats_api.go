...
import (
	...
	import2 "github.com/nutanix-scratch/go-sdk-external/vmm-go-client/v4/models/vmm/v4/esxi/stats"
	"net/http"
	"net/url"
	"strings"
)
...
func (api *EsxiStatsApi) GetVmStats(extId *string, startTime_ *string, endTime_ *string, samplingInterval_ *int, statType_ *import1.DownSamplingOperator, select_ *string, args ...map[string]interface{}) (*import2.GetVmStatsResponse, error) {
	...
	unmarshalledResp := new(import2.GetVmStatsResponse)
...
func (api *EsxiStatsApi) ListVmStats(startTime_ *string, endTime_ *string, samplingInterval_ *int, statType_ *import1.DownSamplingOperator, page_ *int, limit_ *int, filter_ *string, orderby_ *string, select_ *string, args ...map[string]interface{}) (*import2.ListVmStatsResponse, error) {
	argMap := make(map[string]interface{})
	if len(args) > 0 {
		argMap = args[0]
	}
	...
	unmarshalledResp := new(import2.ListVmStatsResponse)
	json.Unmarshal(responseBody.([]byte), &unmarshalledResp)
	return unmarshalledResp, err
}
