# Go Client For Nutanix VMM APIs
...
```shell
$ go get github.com/nutanix-scratch/go-sdk-external/vmm-go-client/v4/...
```

##### Install a specific version

```shell
$ go get github.com/nutanix-scratch/go-sdk-external/vmm-go-client/v4/...@v4.0.1-beta.1
```
...
require (
	github.com/nutanix-scratch/go-sdk-external/vmm-go-client/v4 latest
)
```
...
require (
	github.com/nutanix-scratch/go-sdk-external/vmm-go-client/v4 v4.0.1-beta.1
)
```
...
import (
	"github.com/nutanix-scratch/go-sdk-external/vmm-go-client/v4/client"
	"github.com/nutanix-scratch/go-sdk-external/vmm-go-client/v4/api"
)
...
extId := "FfCDDAFd-8caC-E4D1-f5f9-eAB7a1bB4824"
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=vmm&version=v4.0.b1&language=go). This documentation is auto-generated, and the location may change.
