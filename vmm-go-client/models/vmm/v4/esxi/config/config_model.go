...
import (
	...
	"errors"
	"fmt"
	import3 "github.com/nutanix-scratch/go-sdk-external/vmm-go-client/v4/models/common/v1/response"
	import1 "github.com/nutanix-scratch/go-sdk-external/vmm-go-client/v4/models/prism/v4/config"
	import2 "github.com/nutanix-scratch/go-sdk-external/vmm-go-client/v4/models/vmm/v4/error"
	"time"
)
...
*/
type RevertEsxiVmResponse struct {
	ObjectType_ *string `json:"$objectType,omitempty"`
	...
	Data *OneOfRevertEsxiVmResponseData `json:"data,omitempty"`

	Metadata *import3.ApiResponseMetadata `json:"metadata,omitempty"`
}

func NewRevertEsxiVmResponse() *RevertEsxiVmResponse {
	p := new(RevertEsxiVmResponse)
	p.ObjectType_ = new(string)
	*p.ObjectType_ = "vmm.v4.esxi.config.RevertEsxiVmResponse"
	p.Reserved_ = map[string]interface{}{"$fv": "v4.r0.b1"}
	p.UnknownFields_ = map[string]interface{}{}
...
func (p *RevertEsxiVmResponse) GetData() interface{} {
	if nil == p.Data {
		return nil
	}
	return p.Data.GetValue()
...
func (p *RevertEsxiVmResponse) SetData(v interface{}) error {
	if nil == p.Data {
		p.Data = NewOneOfRevertEsxiVmResponseData()
	}
	e := p.Data.SetValue(v)
	if nil == e {
		if nil == p.DataItemDiscriminator_ {
...
type OneOfRevertEsxiVmResponseData struct {
	Discriminator *string                `json:"-"`
	ObjectType_   *string                `json:"-"`
	oneOfType400  *import2.ErrorResponse `json:"-"`
	oneOfType2001 *import1.TaskReference `json:"-"`
...
func NewOneOfRevertEsxiVmResponseData() *OneOfRevertEsxiVmResponseData {
	p := new(OneOfRevertEsxiVmResponseData)
	p.Discriminator = new(string)
	p.ObjectType_ = new(string)
	return p
}

func (p *OneOfRevertEsxiVmResponseData) SetValue(v interface{}) error {
	if nil == p {
		return errors.New(fmt.Sprintf("OneOfRevertEsxiVmResponseData is nil"))
	}
	switch v.(type) {
	case import2.ErrorResponse:
		if nil == p.oneOfType400 {
...
func (p *OneOfRevertEsxiVmResponseData) GetValue() interface{} {
	if p.oneOfType400 != nil && *p.oneOfType400.ObjectType_ == *p.Discriminator {
		return *p.oneOfType400
	}
	if p.oneOfType2001 != nil && *p.oneOfType2001.ObjectType_ == *p.Discriminator {
...
func (p *OneOfRevertEsxiVmResponseData) UnmarshalJSON(b []byte) error {
	vOneOfType400 := new(import2.ErrorResponse)
	if err := json.Unmarshal(b, vOneOfType400); err == nil {
		if "vmm.v4.error.ErrorResponse" == *vOneOfType400.ObjectType_ {
			if nil == p.oneOfType400 {
	...
	return errors.New(fmt.Sprintf("Unable to unmarshal for OneOfRevertEsxiVmResponseData"))
}

func (p *OneOfRevertEsxiVmResponseData) MarshalJSON() ([]byte, error) {
	if p.oneOfType400 != nil && *p.oneOfType400.ObjectType_ == *p.Discriminator {
		return json.Marshal(p.oneOfType400)
	}
	if p.oneOfType2001 != nil && *p.oneOfType2001.ObjectType_ == *p.Discriminator {
	...
	return nil, errors.New("No value to marshal for OneOfRevertEsxiVmResponseData")
}
