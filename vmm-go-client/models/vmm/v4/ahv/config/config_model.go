...
import (
	...
	"errors"
	"fmt"
	import1 "github.com/nutanix-scratch/go-sdk-external/vmm-go-client/v4/models/common/v1/config"
	import4 "github.com/nutanix-scratch/go-sdk-external/vmm-go-client/v4/models/common/v1/response"
	import5 "github.com/nutanix-scratch/go-sdk-external/vmm-go-client/v4/models/dataprotection/v4/common"
	import2 "github.com/nutanix-scratch/go-sdk-external/vmm-go-client/v4/models/prism/v4/config"
	import3 "github.com/nutanix-scratch/go-sdk-external/vmm-go-client/v4/models/vmm/v4/error"
	"time"
)
...
*/
type VmMigrateToHostResponse struct {
	ObjectType_ *string `json:"$objectType,omitempty"`
	...
	Data *OneOfVmMigrateToHostResponseData `json:"data,omitempty"`

	Metadata *import4.ApiResponseMetadata `json:"metadata,omitempty"`
}

func NewVmMigrateToHostResponse() *VmMigrateToHostResponse {
	p := new(VmMigrateToHostResponse)
	p.ObjectType_ = new(string)
	*p.ObjectType_ = "vmm.v4.ahv.config.VmMigrateToHostResponse"
	p.Reserved_ = map[string]interface{}{"$fv": "v4.r0.b1"}
	p.UnknownFields_ = map[string]interface{}{}
...
func (p *VmMigrateToHostResponse) GetData() interface{} {
	if nil == p.Data {
		return nil
	}
	return p.Data.GetValue()
...
func (p *VmMigrateToHostResponse) SetData(v interface{}) error {
	if nil == p.Data {
		p.Data = NewOneOfVmMigrateToHostResponseData()
	}
	e := p.Data.SetValue(v)
	if nil == e {
		if nil == p.DataItemDiscriminator_ {
...
type OneOfVmMigrateToHostResponseData struct {
	Discriminator *string                `json:"-"`
	ObjectType_   *string                `json:"-"`
	oneOfType2001 *import2.TaskReference `json:"-"`
	oneOfType400  *import3.ErrorResponse `json:"-"`
...
func NewOneOfVmMigrateToHostResponseData() *OneOfVmMigrateToHostResponseData {
	p := new(OneOfVmMigrateToHostResponseData)
	p.Discriminator = new(string)
	p.ObjectType_ = new(string)
	return p
}

func (p *OneOfVmMigrateToHostResponseData) SetValue(v interface{}) error {
	if nil == p {
		return errors.New(fmt.Sprintf("OneOfVmMigrateToHostResponseData is nil"))
	}
	switch v.(type) {
	case import2.TaskReference:
		if nil == p.oneOfType2001 {
...
func (p *OneOfVmMigrateToHostResponseData) GetValue() interface{} {
	if p.oneOfType2001 != nil && *p.oneOfType2001.ObjectType_ == *p.Discriminator {
		return *p.oneOfType2001
	}
	if p.oneOfType400 != nil && *p.oneOfType400.ObjectType_ == *p.Discriminator {
...
func (p *OneOfVmMigrateToHostResponseData) UnmarshalJSON(b []byte) error {
	vOneOfType2001 := new(import2.TaskReference)
	if err := json.Unmarshal(b, vOneOfType2001); err == nil {
		if "prism.v4.config.TaskReference" == *vOneOfType2001.ObjectType_ {
			if nil == p.oneOfType2001 {
	...
	return errors.New(fmt.Sprintf("Unable to unmarshal for OneOfVmMigrateToHostResponseData"))
}

func (p *OneOfVmMigrateToHostResponseData) MarshalJSON() ([]byte, error) {
	if p.oneOfType2001 != nil && *p.oneOfType2001.ObjectType_ == *p.Discriminator {
		return json.Marshal(p.oneOfType2001)
	}
	if p.oneOfType400 != nil && *p.oneOfType400.ObjectType_ == *p.Discriminator {
	...
	return nil, errors.New("No value to marshal for OneOfVmMigrateToHostResponseData")
}
