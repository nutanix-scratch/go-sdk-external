...
import (
	...
	"errors"
	"fmt"
	import2 "github.com/nutanix-scratch/go-sdk-external/vmm-go-client/v4/models/common/v1/response"
	import1 "github.com/nutanix-scratch/go-sdk-external/vmm-go-client/v4/models/vmm/v4/error"
	"time"
)
...
*/
type GetVmDiskStatsResponse struct {
	...
	Data *OneOfGetVmDiskStatsResponseData `json:"data,omitempty"`

	Metadata *import2.ApiResponseMetadata `json:"metadata,omitempty"`
}

func NewGetVmDiskStatsResponse() *GetVmDiskStatsResponse {
	p := new(GetVmDiskStatsResponse)
	p.ObjectType_ = new(string)
	*p.ObjectType_ = "vmm.v4.ahv.stats.GetVmDiskStatsResponse"
...
func (p *GetVmDiskStatsResponse) GetData() interface{} {
	if nil == p.Data {
		return nil
	}
...
func (p *GetVmDiskStatsResponse) SetData(v interface{}) error {
	if nil == p.Data {
		p.Data = NewOneOfGetVmDiskStatsResponseData()
	}
	e := p.Data.SetValue(v)
	if nil == e {
...
type GetVmStatsResponse struct {
	...
	Data *OneOfGetVmStatsResponseData `json:"data,omitempty"`

	Metadata *import2.ApiResponseMetadata `json:"metadata,omitempty"`
}

func NewGetVmStatsResponse() *GetVmStatsResponse {
	p := new(GetVmStatsResponse)
	p.ObjectType_ = new(string)
	*p.ObjectType_ = "vmm.v4.ahv.stats.GetVmStatsResponse"
	p.Reserved_ = map[string]interface{}{"$fv": "v4.r0.b1"}
	p.UnknownFields_ = map[string]interface{}{}
...
func (p *GetVmStatsResponse) GetData() interface{} {
	if nil == p.Data {
		return nil
	}
	return p.Data.GetValue()
...
func (p *GetVmStatsResponse) SetData(v interface{}) error {
	if nil == p.Data {
		p.Data = NewOneOfGetVmStatsResponseData()
	}
	e := p.Data.SetValue(v)
	if nil == e {
		if nil == p.DataItemDiscriminator_ {
...
*/
type ListVmStatsResponse struct {
	ObjectType_ *string `json:"$objectType,omitempty"`
	...
	Data *OneOfListVmStatsResponseData `json:"data,omitempty"`

	Metadata *import2.ApiResponseMetadata `json:"metadata,omitempty"`
}

func NewListVmStatsResponse() *ListVmStatsResponse {
	p := new(ListVmStatsResponse)
	p.ObjectType_ = new(string)
	*p.ObjectType_ = "vmm.v4.ahv.stats.ListVmStatsResponse"
	p.Reserved_ = map[string]interface{}{"$fv": "v4.r0.b1"}
	p.UnknownFields_ = map[string]interface{}{}
...
func (p *ListVmStatsResponse) GetData() interface{} {
	if nil == p.Data {
		return nil
	}
	return p.Data.GetValue()
...
func (p *ListVmStatsResponse) SetData(v interface{}) error {
	if nil == p.Data {
		p.Data = NewOneOfListVmStatsResponseData()
	}
	e := p.Data.SetValue(v)
	if nil == e {
		if nil == p.DataItemDiscriminator_ {
...
type OneOfGetVmDiskStatsResponseData struct {
...
func NewOneOfGetVmDiskStatsResponseData() *OneOfGetVmDiskStatsResponseData {
	p := new(OneOfGetVmDiskStatsResponseData)
	p.Discriminator = new(string)
	p.ObjectType_ = new(string)
	return p
}

func (p *OneOfGetVmDiskStatsResponseData) SetValue(v interface{}) error {
	if nil == p {
		return errors.New(fmt.Sprintf("OneOfGetVmDiskStatsResponseData is nil"))
	}
	switch v.(type) {
	case VmDiskStats:
...
func (p *OneOfGetVmDiskStatsResponseData) GetValue() interface{} {
...
func (p *OneOfGetVmDiskStatsResponseData) UnmarshalJSON(b []byte) error {
	...
	return errors.New(fmt.Sprintf("Unable to unmarshal for OneOfGetVmDiskStatsResponseData"))
}

func (p *OneOfGetVmDiskStatsResponseData) MarshalJSON() ([]byte, error) {
	if p.oneOfType2001 != nil && *p.oneOfType2001.ObjectType_ == *p.Discriminator {
	...
	return nil, errors.New("No value to marshal for OneOfGetVmDiskStatsResponseData")
}

type OneOfListVmStatsResponseData struct {
	Discriminator *string                `json:"-"`
	ObjectType_   *string                `json:"-"`
...
func NewOneOfListVmStatsResponseData() *OneOfListVmStatsResponseData {
	p := new(OneOfListVmStatsResponseData)
	p.Discriminator = new(string)
	p.ObjectType_ = new(string)
	return p
}

func (p *OneOfListVmStatsResponseData) SetValue(v interface{}) error {
	if nil == p {
		return errors.New(fmt.Sprintf("OneOfListVmStatsResponseData is nil"))
	}
	switch v.(type) {
	case []VmStats:
...
func (p *OneOfListVmStatsResponseData) GetValue() interface{} {
...
func (p *OneOfListVmStatsResponseData) UnmarshalJSON(b []byte) error {
	...
	return errors.New(fmt.Sprintf("Unable to unmarshal for OneOfListVmStatsResponseData"))
}

func (p *OneOfListVmStatsResponseData) MarshalJSON() ([]byte, error) {
	if "List<vmm.v4.ahv.stats.VmStats>" == *p.Discriminator {
		return json.Marshal(p.oneOfType2001)
	}
	if p.oneOfType400 != nil && *p.oneOfType400.ObjectType_ == *p.Discriminator {
	...
	return nil, errors.New("No value to marshal for OneOfListVmStatsResponseData")
}

type OneOfGetVmStatsResponseData struct {
	Discriminator *string                `json:"-"`
	ObjectType_   *string                `json:"-"`
	oneOfType2001 *VmStats               `json:"-"`
	oneOfType400  *import1.ErrorResponse `json:"-"`
...
func NewOneOfGetVmStatsResponseData() *OneOfGetVmStatsResponseData {
	p := new(OneOfGetVmStatsResponseData)
	p.Discriminator = new(string)
	p.ObjectType_ = new(string)
	return p
}

func (p *OneOfGetVmStatsResponseData) SetValue(v interface{}) error {
	if nil == p {
		return errors.New(fmt.Sprintf("OneOfGetVmStatsResponseData is nil"))
	}
	switch v.(type) {
	case VmStats:
		if nil == p.oneOfType2001 {
...
func (p *OneOfGetVmStatsResponseData) GetValue() interface{} {
	if p.oneOfType2001 != nil && *p.oneOfType2001.ObjectType_ == *p.Discriminator {
		return *p.oneOfType2001
	}
	if p.oneOfType400 != nil && *p.oneOfType400.ObjectType_ == *p.Discriminator {
...
func (p *OneOfGetVmStatsResponseData) UnmarshalJSON(b []byte) error {
	vOneOfType2001 := new(VmStats)
	if err := json.Unmarshal(b, vOneOfType2001); err == nil {
	...
	return errors.New(fmt.Sprintf("Unable to unmarshal for OneOfGetVmStatsResponseData"))
}

func (p *OneOfGetVmStatsResponseData) MarshalJSON() ([]byte, error) {
	if p.oneOfType2001 != nil && *p.oneOfType2001.ObjectType_ == *p.Discriminator {
		return json.Marshal(p.oneOfType2001)
	}
	if p.oneOfType400 != nil && *p.oneOfType400.ObjectType_ == *p.Discriminator {
	...
	return nil, errors.New("No value to marshal for OneOfGetVmStatsResponseData")
}
