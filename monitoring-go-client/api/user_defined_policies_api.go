...
import (
	...
	import1 "github.com/nutanix-scratch/go-sdk-external/monitoring-go-client/v4/models/monitoring/v4/serviceability"
	"net/http"
	"net/url"
	"strings"
)
...
func (api *UserDefinedPoliciesApi) CreateUdaPolicy(body *import1.UserDefinedPolicy, args ...map[string]interface{}) (*import1.CreateUdaPolicyApiResponse, error) {
	...
	uri := "/api/monitoring/v4.0.b1/serviceability/alerts/user-defined-policies"
...
// Delete a User-Defined Alert policy identified by {extId}.
func (api *UserDefinedPoliciesApi) DeleteUdaPolicyById(extId *string, args ...map[string]interface{}) (*import1.DeleteUdaPolicyApiResponse, error) {
	...
	uri := "/api/monitoring/v4.0.b1/serviceability/alerts/user-defined-policies/{extId}"
...
// Get all the existing policies that have conflicting criteria to a User-Defined Alert policy identified by {extId}.
func (api *UserDefinedPoliciesApi) FindConflictingUdaPolicies(body *import1.UserDefinedPolicy, args ...map[string]interface{}) (*import1.FindConflictingUdaPoliciesApiResponse, error) {
	...
	uri := "/api/monitoring/v4.0.b1/serviceability/alerts/user-defined-policies/$actions/find-conflicts"
...
// Get the details of a User-Defined Alert policy identified by {extId}.
...
// Query the list of User-Defined Alert policies.
...
// Update a User-Defined Alert policy identified by {extId}.
