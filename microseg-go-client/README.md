# Go Client For Nutanix Microseg Versioned APIs

The Go client for Nutanix Microseg Versioned APIs is designed for Go client application developers offering them simple and flexible access to APIs that manage Network Security Policy configuration of Nutanix clusters.
...
```shell
$ go get github.com/nutanix-scratch/go-sdk-external/microseg-go-client/v4/...
```

##### Install a specific version

```shell
$ go get github.com/nutanix-scratch/go-sdk-external/microseg-go-client/v4/...@v4.0.1-beta.1
```
...
require (
	github.com/nutanix-scratch/go-sdk-external/microseg-go-client/v4 latest
)
```
...
require (
	github.com/nutanix-scratch/go-sdk-external/microseg-go-client/v4 v4.0.1-beta.1
)
```


## Configuration
The Go client for Nutanix Microseg Versioned APIs can be configured with the following parameters
...
```go
import (
	"github.com/nutanix-scratch/go-sdk-external/microseg-go-client/v4/client"
)
var (
...
import (
	"github.com/nutanix-scratch/go-sdk-external/microseg-go-client/v4/client"
	"github.com/nutanix-scratch/go-sdk-external/microseg-go-client/v4/api"
)

var (
	ApiClientInstance *client.ApiClient
	AddressGroupsApiInstance *api.AddressGroupsApi
)
...
// ...
addressGroup := getResponse.GetData().(import1.AddressGroup)

// The body parameter in the following operation is received from the previous GET request's response which needs to be updated.
response, err := AddressGroupsApiInstance.UpdateAddressGroupById(&addressGroup&extId, , args)
if err != nil {
....
}
```
...
// 
response, err := AddressGroupsApiInstance.ListAddressGroups(&page_, &limit_, &filter_, &orderby_, &select_)
if err != nil {
    ....
}
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=microseg&version=v4.0.b1&language=go). This documentation is auto-generated, and the location may change.
